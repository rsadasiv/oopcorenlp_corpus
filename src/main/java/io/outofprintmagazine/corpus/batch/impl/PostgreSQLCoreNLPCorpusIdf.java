...
public class PostgreSQLCoreNLPCorpusIdf extends CorpusBatchStep {
	
	private static final Logger logger = LogManager.getLogger(PostgreSQLCoreNLPCorpusIdf.class);
	...
	public PostgreSQLCoreNLPCorpusIdf() {
		super();
	}
