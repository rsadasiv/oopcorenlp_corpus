...
public class ParseStoryRegex extends CorpusBatchStep implements ICorpusBatchStep {

	private static final Logger logger = LogManager.getLogger(ParseStoryRegex.class);
	...
	public ArrayNode runOne(ObjectNode inputStepItem) throws Exception {
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				line = line.trim();
				if (line.equals(inputStepItem.get("esnlc_DocTitleAnnotation").asText())) {
					if (++candidatesSeen == tocCandidates.size()) {
						inStory = true;
					}
				}
