...
public class PostgreSQLCoreNLPTfidfScoresLoader extends ThreadedCorpusBatchStepTask implements CorpusBatchStepTask {

	private static final Logger logger = LogManager.getLogger(PostgreSQLCoreNLPTfidfScoresLoader.class);
	
	private DocumentStorage loader = null;
	
	public PostgreSQLCoreNLPTfidfScoresLoader() {
		super();
	}
	...
	public ArrayNode runOne(ObjectNode inputStepItem) throws Exception {
		...
		loader.storeOOPTfidfScores(
				getData().getCorpusId(),
				getData().getCorpusBatchId(),
				getDocID(inputStepItem),
				(ObjectNode) getJsonNodeFromStorage(inputStepItem, "oopNLPTfidfScoresStorage")
		);
		

		outputStepItem.put("PostgreSQLCoreNLPTfidfScoresLoader", "true");
