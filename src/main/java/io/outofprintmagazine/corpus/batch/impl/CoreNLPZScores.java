...
public class CoreNLPZScores extends CorpusBatchStep {
	...
	public ArrayNode runOne(ObjectNode input) throws Exception {
		...
		ObjectNode corpusAggregateScores = (ObjectNode) getJsonNodeFromStorage(input, "oopNLPCorpusAggregateScoresStorage");
